...
const ATTRIBUTE_LABELS = [
  { key: "speedBonus", label: "Speed", hint: "Reduce fishing time", color: "#8B6355" },
  { key: "weightBonus", label: "Weight", hint: "Increase weight range", color: "#8B6355" },
  { key: "luckBonus", label: "Luck", hint: "Higher rarity chance", color: "#8B6355" },
  { key: "stabilityBps", label: "Stability", hint: "Reduce debuff impact", color: "#8B6355" },
] as const;
