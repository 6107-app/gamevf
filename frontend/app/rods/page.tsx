      ...
      <div style={{
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <p style={{
            ...
            {requiredTier
              ? `${requiredTier} rooms require a rod of level ${requiredLevel} or higher. Click any rod to enter the room.`
              : "All the rods you own. Click any rod to view details, upgrade, or repair it."}
          </p>
        </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "15px", marginBottom: "16px" }}>
              {wallet.address ? requiredTier
                ? `No rods of level ${requiredLevel} or higher`
        ...
        <div style={{
          ...
          <p style={{
            ...
            Don't have other rod types yet? Purchase a new rod now to expand your collection.
          </p>
                      ...
                      style={{
                        ...
                        try {
                          ...
                          if (SIMULATE) {
                            ...
                            alert(`Simulated mint: price ${ethers.formatEther(sim.price)} ETH, estimated gas ${sim.gasEstimate ? sim.gasEstimate.toString() : 'n/a'}`);
                            return;
                          }
