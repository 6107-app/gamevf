...
export const ROD_TYPES: Record<RodType, { name: string; icon: string; description: string }> = {
  Driftwood: {
    name: "Driftwood Rod",
    icon: "🎣",
    description: "Common-tier rod. Starting price 0.01 ETH. Base attributes: Speed +3% / Weight +3%",
  },
  Tidebreaker: {
    name: "Tidebreaker Rod",
    icon: "⚡",
    description: "Rare-tier rod. Starting price 0.05 ETH. Base attributes: Speed +10% / Weight +2%",
  },
  Leviathan: {
    name: "Leviathan Rod",
    icon: "💪",
    description: "Super Rare-tier rod. Starting price 0.08 ETH. Base attributes: Luck +5% / Stability +2%",
  },
  AbyssWhisper: {
    name: "Abyss Whisper Rod",
    icon: "✨",
    description: "Epic-tier rod. Starting price 0.15 ETH. Base attributes: Luck +10% / Stability +5%",
  },
};
